...
const page = () => {
  ...
  return user.id && (
    <motion.div initial="hidden" animate="visible" className="flex flex-col items-center gap-6 w-full max-w-[1250px] bg-white p-10 rounded-xl shadow-md sm:mt-0 mt-[150px] shadow-neutral-200 border border-neutral-100">
      <ToastMessage />
