...
import { COMPLETE_DME_CHALLENGE_2 } from "@/graphql/mutations";
...
const Challenge2 = ({ handleFunction, showState, handleRefetch }: ChallengeProps) => {
  const {user} = infoUser()

  const [completeChallenge2] = useMutation(COMPLETE_DME_CHALLENGE_2)
  ...
  return (
    ...
    >
      ...
      {players.player1?.league === "Brasileirão Série A" &&
      players.player2?.league === "Brasileirão Série A" &&
      players.player3?.league === "Brasileirão Série A" &&
      players.player1 !== null &&
      players.player2 !== null &&
      players.player3 !== null &&
      players.player1?.overall && players.player1.overall >= 76 ||
      players.player2?.overall && players.player2.overall >= 76 ||
      players.player3?.overall && players.player3.overall >= 76 ? (
        <button
