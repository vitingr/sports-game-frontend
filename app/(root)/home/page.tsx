  ...
  return (
    <div className="w-full flex flex-col items-center gap-6 max-w-[1250px] mt-[3em]">
      ...
      <section className="flex justify-between gap-8 w-full mt-[6.5em] sm:flex-nowrap flex-wrap">
        <div className="w-full bg-white p-8 rounded-b-xl border-t-2 border-t-indigo-600 border border-neutral-100 shadow-sm shadow-neutral-200 min-h-[300px] flex gap-12 sm:flex-row flex-col items-center" id="stats">
          <DoughnutChart
            chartOptions={config}
            chartData={{
        ...
        <div className="max-w-[450px] w-full bg-white rounded-b-xl border-t-2 border-t-indigo-600 p-8 border border-neutral-100 shadow-sm shadow-neutral-200 min-h-[300px]" id="ranking">
      ...
      <section className="w-full mt-[6.5em] flex justify-around gap-10 sm:flex-nowrap flex-wrap">
        <div className="bg-white rounded-xl p-8 border border-neutral-100 shadow-sm shadow-neutral-200 flex flex-col items-center w-full h-[300px] cursor-pointer transition-all duration-300 hover:scale-105" id="shop">
        ...
        <div className="bg-white rounded-xl p-8 border border-neutral-100 shadow-sm shadow-neutral-200 flex flex-col items-center w-full h-[300px] cursor-pointer transition-all duration-300 hover:scale-105" id="market">
        ...
        <div className="bg-white rounded-xl p-8 border border-neutral-100 shadow-sm shadow-neutral-200 flex flex-col items-center w-full h-[300px] cursor-pointer transition-all duration-300 hover:scale-105" id="lineups">
      ...
      <section className="w-full flex justify-between gap-6 bg-white rounded-b-xl border-t-2 border-t-indigo-600 p-10 border border-neutral-100 shadow-sm shadow-neutral-200 mt-[6.5em]" id="dme">
        <div className="w-full">
