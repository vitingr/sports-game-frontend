        ...
        <div className="w-full flex justify-center items-center gap-6">
          {user ? (
            ...
            <>
              <Link
                href={"/sign-in"}
                className="w-[100px] px-4 py-2 text-sm cursor-pointer rounded-xl bg-[#5BB5A2] text-white text-center"
              >
                Login
              </Link>
              <Link
                href={"/sign-up"}
                className="w-[100px] px-4 py-2 text-sm cursor-pointer rounded-xl border border-[#5BB5A2] text-[#5BB5A2] text-center"
              >
                Cadastro
              </Link>
            </>
